            ...
            <div class="card z-index-0 fadeIn3 fadeInBottom">
              <div class="card-header p-0 position-relative mt-n4 mx-3 z-index-2">
                <div class="bg-gradient-primary shadow-primary border-radius-lg py-3 pe-1">
                  <h4 class="text-white font-weight-bolder text-center mt-2 mb-0">Tambah Toko</h4>
                </div>
              </div>
            <div class="card-body">
            <form method="post"' action="{{route('adm.shop.store')}}" enctype="multipart/form-data" class="text-start">
                @csrf
                ...
                <div class="input-group input-group-outline my-3">
                <img class="img-fluid shadow border-radius-xl" id="frame"  height="200" width="350"">
                </div>
                <div class="input-group input-group-outline my-3">
