            ...
            <div class="card z-index-0 fadeIn3 fadeInBottom">
              <div class="card-header p-0 position-relative mt-n4 mx-3 z-index-2">
                <div class="bg-gradient-primary shadow-primary border-radius-lg py-3 pe-1">
                  <h4 class="text-white font-weight-bolder text-center mt-2 mb-0">Edit Produk</h4>
                </div>
              </div>
            <div class="card-body">
            <form method="post"' action="{{route('adm.product.update',$produk->id)}}" enctype="multipart/form-data" class="text-start">
                @csrf
                ...
                <div class="input-group input-group-outline my-3">
                    ...
                    <input type="text" class="form-control" name="satuan" placeholder="Per Kg" value="{{$produk->satuan}}" >
                </div>
                <div class="input-group input-group-outline my-3">
                ...
                <div class="input-group input-group-outline my-3">
                <img class="img-fluid shadow border-radius-xl" id="frame" src="{{ asset('images/'.$produk->foto_produk) }}" alt="{{ asset('images/'.$produk->foto_produk) }}" height="261" width="261"">
                </div>
                <div class="input-group input-group-outline my-3">
